    ...
    return (
        <S.Main>
            <S.SobreMim>Meu nome é Agatha Cristiane Pinheiro dos Santos, tenho 33 anos e sou graduada em Análise e desenvolvimento de sistemas .
                Atualmente estou desenvolvendo habilidades para o desenvolvimento front-end, com tecnologias como HTML, CSS, JavaScript, ReactJs,Styled-components, Git/GitHub e lógica de programação . 
